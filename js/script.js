...
function addWeb() 
{
    if (submitbutton.innerHTML=='submit'){
        if(validation ()==true && validatSiteName ()== true &&validatSiteUrl ()==true){
            var web = {
                Name: siteName.value,
                Url: siteUrl.value
            }
...
function NameError ()
{
var nameRequired=document.getElementById('nameError') .innerHTML=(`<p class='bg-red'>Name is required</p>`)
document.getElementById('nameError').classList.remove('d-none')
}
function urlError ()
{
    var urlError = document.getElementById('urlError').innerHTML=(`<p  class='bg-red'>Url Field is required </p>`)
